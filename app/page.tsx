...
import { Box, Typography, Stack, Chip, Container, GridLegacy as Grid } from "@mui/material";
import { Timer, TrendingUp, EmojiEvents, BarChart, CheckCircle, Apps } from "@mui/icons-material";
import { FeatureCard, SectionContainer, CTAButton } from "@stridetime/ui";
import { gradients } from "@stridetime/ui";
   ...
   <Box
    ...
    <Container maxWidth="lg" sx={{ position: "relative", zIndex: 1 }}>
     <Stack alignItems="center" spacing={3} textAlign="center">
      <Chip label="Coming Soon" color="primary" sx={{ fontWeight: 600 }} />
      <Typography
       variant="h1"
       sx={{
      ...
      <Typography
       ...
       Understand your work patterns, stay motivated, and achieve more with intelligent productivity
       tracking.
      </Typography>
      <Stack direction={{ xs: "column", sm: "row" }} spacing={2} sx={{ pt: 2 }}>
       <CTAButton variant="primary" size="large" disabled>
        Coming Soon
       </CTAButton>
     ...
     <Grid container spacing={6} alignItems="center">
      <Grid item xs={12} md={6}>
       ...
       <Typography variant="body1" color="text.secondary" paragraph>
        Stride is designed for anyone who wants to understand their productivity better. Whether
        you're coding, designing, writing, or managing projects—track what matters and improve over
        time.
       </Typography>
    ...
    <SectionContainer>
     <Stack alignItems="center" spacing={3} textAlign="center">
      ...
      <Typography variant="body1" sx={{ maxWidth: 600, opacity: 0.9 }}>
       Join the waitlist and be notified when Stride launches. Get early access to the productivity
